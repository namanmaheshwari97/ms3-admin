...
export namespace EmailBlacklistAdd {
  export const REQUEST = 'EmailBlacklistAddEffects.REQUEST';
  export const SUCCESS = 'EmailBlacklistAddEffects.SUCCESS';
  export const ERROR = 'EmailBlacklistAddEffects.ERROR';
  ...
  export class Effects {
    ...
    @Effect() onSuccess$: Observable<Action> = this.actions$
      ...
      .map((payload) => new EmailBlacklistActions.AddItem(payload));
